...
use nearapps_send_near::SendNearContract;

near_sdk_sim::lazy_static_include::lazy_static_include_bytes! {
    EXEC_WASM_BYTES => "../res/nearapps_exec.wasm",
    SEND_NEAR_WASM_BYTES => "../res/nearapps_send_near.wasm",
}
...
) -> ContractAccount<SendNearContract> {
    deploy!(
        contract: SendNearContract,
        contract_id: "send-near".to_string(),
        bytes: &SEND_NEAR_WASM_BYTES,
        signer_account: root,
        deposit: parse_near!("200 N"),
