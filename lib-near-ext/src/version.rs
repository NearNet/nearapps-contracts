...
pub struct Version {
    /// The project's name. eg. `my-project`.
    pub name: String,
    /// The project's semver. eg. `0.1.0`.
    pub semver: String,
    /// The git 40-byte commit sha. eg. `2beb5ec70ee2c0490cd0f4964544c998e6badbcc`.
    pub git_sha: String,
