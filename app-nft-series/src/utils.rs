...
/// Identical to [`nft::bytes_for_approved_account_id()`].
...
/// Identical to `nft::assert_at_least_one_yocto()`
...
/// Identical to [`nft::refund_deposit()`].
...
/// Identical to [`nft::refund_approved_account_ids_iter()`].
...
/// Identical to [`nft::refund_approved_account_ids()`].
